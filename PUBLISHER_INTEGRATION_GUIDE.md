...
```json
{
  ...
  "app_key": "100000001",
  "os": "android",
  "adid": "9ee20401-14bf-4569-a8d3-dc577be8d07f",
  "idfa": ""
}
```
...
| `app_key`       | String | Optional  | 앱 식별자<br>멀티 앱 구분용                                                                                                                 | `100000001`                            |
| `os`            | String | Optional  | 운영체제 타입<br>- `android`<br>- `ios`                                                                                                     | `android`                              |
| `adid`          | String | Optional  | Google 광고 식별값 (GAID)<br>Android일 경우 제공                                                                                            | `9ee20401-14bf-4569-a8d3-dc577be8d07f` |
| `idfa`          | String | Optional  | Apple 광고 식별값 (IDFA)<br>iOS일 경우 제공                                                                                                 | `CA3B4F72-8D3E-4A9B-9C2D-1E5F6G7H8I9J` |
...
- **중복 테스트**: 동일한 `callback_id`로 반복 테스트가 필요하신 경우, 개발팀에 요청해 주시면 중복 포스트백을 보내드립니다.
